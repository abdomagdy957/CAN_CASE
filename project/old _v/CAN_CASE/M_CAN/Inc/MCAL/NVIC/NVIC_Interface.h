...
#define GROUP_16_SUB_0 						    0x05FA0300	/*0 bit for sub & 4 bit For group   << 0  */
#define GROUP_8_SUB_2 						    0x05FA0400	/*1 bit for sub & 3 bit For group   << 1  */
#define GROUP_4_SUB_4						    0x05FA0500	/*2 bit for sub & 2 bit For group   << 2  */
#define GROUP_2_SUB_8 						    0x05FA0600	/*3 bit for sub & 1 bit For group   << 3  */
#define GROUP_0_SUB_6 						    0x05FA0700	/*4 bit for sub & 0 bit For group   << 4  */
...
void  NVIC_voidSetIntPriority2(IRQn_Type IRQn, u8 Copy_u8Group, u8 Copy_u8Sub);
